                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                            ...
                            <label className="flex flex-col gap-2">
                                ...
                                <div className="relative flex w-full items-center">
                                    <input
                                        className="form-input w-full h-12 rounded-full border-none bg-input-bg dark:bg-[#1f2b36] pl-6 pr-14 text-base text-charcoal dark:text-white placeholder:text-[#A0A0A0] focus:ring-2 focus:ring-primary outline-none transition-all"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className={`mt-4 flex w-full h-14 rounded-full items-center justify-center text-white text-base font-semibold shadow-[0px_10px_30px_rgba(59,149,234,0.15)] transition-[transform,opacity] duration-200 ease-in-out ${loading
